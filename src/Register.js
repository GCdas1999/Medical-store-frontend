                ...
                <form className="container" onSubmit={handlesubmit}>
                    <div className="card">
                        <div className="card-header">
                            <h1 style={{ color: 'black' }}>User Registeration</h1>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        <label style={{ color: 'black' }}>Full Name <span className="errmsg">*</span></label>
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        <label style={{ color: 'black' }}>Passwordconf <span className="errmsg"></span></label>
                                        <input type='number' value={password} onChange={e => passwordchange(e.target.value)} className="form-control"></input>
                                    </div>
                                </div>
                            </div>
                        </div>
